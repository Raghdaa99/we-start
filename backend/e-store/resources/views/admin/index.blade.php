            ...
            <div class="card card-statistics h-100">
                ...
                <div class="btn-group info-drop">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{ url("#") }}"><i class="text-primary ti-reload"></i>Refresh</a>
                        <a class="dropdown-item" href="{{ url("#") }}"><i class="text-secondary ti-eye"></i>View
                            all</a>
                    </div>
                </div>
                <div class="card-body">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active show" id="months-tab" data-toggle="tab"
                                           href="{{ url("#months") }}" role="tab" aria-controls="months"
                                           aria-selected="true"> Months</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="year-tab" data-toggle="tab" href="{{ url("#year") }}"
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-20">
                            <div class="media">
                                <div class="position-relative">
                                    <img class="img-fluid mr-15 avatar-small" src="{{ asset("/images/item/01.png") }}"
                                         alt="">
                                </div>
                        ...
                        <li class="mb-20">
                            <div class="media">
                                <div class="position-relative clearfix">
                                    <img class="img-fluid mr-15 avatar-small" src="{{ asset("/images/item/02.png") }}"
                                         alt="">
                                </div>
                                <div class="media-body">
                        ...
                        <li class="mb-20">
                            <div class="media">
                                <div class="position-relative">
                                    <img class="img-fluid mr-15 avatar-small" src="{{ asset("/images/item/03.png") }}"
                                         alt="">
                                </div>
                                <div class="media-body">
                        ...
                        <li>
                            <div class="media">
                                <div class="position-relative clearfix">
                                    <img class="img-fluid mr-15 avatar-small" src="{{ asset("/images/item/04.png") }}"
                                         alt="">
                                </div>
                                <div class="media-body">
            ...
            <div class="card card-statistics h-100">
                <div class="p-4 text-center bg" style="background: url(images/bg/01.jpg);">
                    ...
                    <div class="btn-group info-drop">
                        <button type="button" class="dropdown-toggle-split text-white" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false"><i class="ti-more"></i></button>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{ url("#") }}"><i class="text-primary ti-files"></i> Add
                                task</a>
                            <a class="dropdown-item" href="{{ url("#") }}"><i class="text-dark ti-pencil-alt"></i>
                                Edit Profile</a>
                            <a class="dropdown-item" href="{{ url("#") }}"><i class="text-success ti-user"></i> View
                                Profile</a>
                            <a class="dropdown-item" href="{{ url("#") }}"><i class="text-secondary ti-info"></i>
                                Contact Info</a>
                        </div>
                    </div>
                </div>
                <div class="card-body text-center position-relative">
                    ...
                    <div class="social-icons color-icon mt-20">
                        <ul>
                            <li class="social-rss"><a href="{{ url("#") }}"><i class="fa fa-rss"></i></a></li>
                            <li class="social-facebook"><a href="{{ url("#") }}"><i class="fa fa-facebook"></i></a>
                            </li>
                            <li class="social-twitter"><a href="{{ url("#") }}"><i class="fa fa-twitter"></i></a>
                            </li>
                            <li class="social-github"><a href="{{ url("#") }}"><i class="fa fa-github"></i></a></li>
                            <li class="social-youtube"><a href="{{ url("#") }}"><i class="fa fa-youtube"></i></a>
                            </li>
                            <li class="social-instagram"><a href="{{ url("#") }}"><i class="fa fa-instagram"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-12 sm-mb-30">
                        <a href="{{ url("#") }}" data-toggle="modal" data-target="#add-category"
