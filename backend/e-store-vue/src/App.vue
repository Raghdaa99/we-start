            ...
            <div class="px-8 py-4 bg-primary flex items-center cursor-pointer relative group">
                ...
                <div
                    ...
                    <a href="#" class="flex items-center px-6 py-3 hover:bg-gray-100 transition">
                        <img src="src/assets/images/icons/sofa.svg" alt="sofa" class="w-5 h-5 object-contain">
                        <span class="ml-6 text-gray-600 text-sm">Sofa</span>
                    </a>
                    <a href="#" class="flex items-center px-6 py-3 hover:bg-gray-100 transition">
                        <img src="src/assets/images/icons/terrace.svg" alt="terrace" class="w-5 h-5 object-contain">
                        <span class="ml-6 text-gray-600 text-sm">Terarce</span>
                    </a>
                    <a href="#" class="flex items-center px-6 py-3 hover:bg-gray-100 transition">
                        <img src="src/assets/images/icons/bed.svg" alt="bed" class="w-5 h-5 object-contain">
                        <span class="ml-6 text-gray-600 text-sm">Bed</span>
                    </a>
                    <a href="#" class="flex items-center px-6 py-3 hover:bg-gray-100 transition">
                        <img src="src/assets/images/icons/office.svg" alt="office" class="w-5 h-5 object-contain">
                        <span class="ml-6 text-gray-600 text-sm">office</span>
                    </a>
                    <a href="#" class="flex items-center px-6 py-3 hover:bg-gray-100 transition">
                        <img src="src/assets/images/icons/outdoor-cafe.svg" alt="outdoor"
                            class="w-5 h-5 object-contain">
                        <span class="ml-6 text-gray-600 text-sm">Outdoor</span>
                    </a>
                    <a href="#" class="flex items-center px-6 py-3 hover:bg-gray-100 transition">
                        <img src="src/assets/images/icons/bed-2.svg" alt="Mattress" class="w-5 h-5 object-contain">
            ...
            <div class="flex items-center justify-between flex-grow pl-12">
                ...
                <template v-if="userStore.user.token">
                    <a @click.prevent="logout" href="/logout"
                        class="text-gray-200 ml-4 hover:text-white transition">Logout</a>
                </template>
                <div v-else>
                    <RouterLink to="/login" class="text-gray-200 ml-4 hover:text-white transition">Login</RouterLink>
                    <RouterLink to="/register" class="text-gray-200 ml-4 hover:text-white transition">Register
                    </RouterLink>
                </div>
