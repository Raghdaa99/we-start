                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="en_smalldesc" class="form-control"
                                                              placeholder="Small Description" rows="5">
                                                        {{ old('en_smalldesc', $product->en_smalldesc) }}
                                                    </textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="ar_smalldesc" class="form-control"
                                                              placeholder="Small Description" rows="5">
                                                        {{ old('ar_smalldesc', $product->ar_smalldesc) }}
                                                    </textarea>
                                                </div>
                                            </div>
