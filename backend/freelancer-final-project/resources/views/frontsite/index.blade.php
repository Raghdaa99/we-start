	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="{{ url("jobs-list-layout-1.html") }}" class="photo-box small" data-background-image="images/job-category-01.jpg">
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="{{ url("jobs-list-layout-full-page-map.html") }}" class="photo-box small" data-background-image="images/job-category-02.jpg">
					<div class="photo-box-content">
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="{{ url("jobs-grid-layout-full-page.html") }}" class="photo-box small" data-background-image="images/job-category-03.jpg">
					<div class="photo-box-content">
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="{{ url("jobs-list-layout-2.html") }}" class="photo-box small" data-background-image="images/job-category-04.jpg">
					<div class="photo-box-content">
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="{{ url("jobs-list-layout-1.html") }}" class="photo-box small" data-background-image="images/job-category-05.jpg">
					<div class="photo-box-content">
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="{{ url("jobs-list-layout-full-page-map.html") }}" class="photo-box small" data-background-image="images/job-category-06.jpg">
					<div class="photo-box-content">
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="{{ url("jobs-grid-layout-full-page.html") }}" class="photo-box small" data-background-image="images/job-category-07.jpg">
					<div class="photo-box-content">
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="{{ url("jobs-list-layout-2.html") }}" class="photo-box small" data-background-image="images/job-category-08.jpg">
					<div class="photo-box-content">
		...
		<div class="row">
			<div class="col-xl-12">
				...
				<div class="section-headline margin-top-0 margin-bottom-35">
					<h3>Recent Tasks</h3>
					<a href="{{ url("tasks-list-layout-1.html") }}" class="headline-link">Browse All Tasks</a>
				</div>
				...
				<div class="tasks-list-container compact-list margin-top-35">
					...
					<!-- Task -->
					<a href="{{ url("single-task-page.html") }}" class="task-listing">
